          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-border/50 bg-background px-3 py-2 text-[13px]"
                placeholder="Misal: WebGIS Developer"
              />
            </div>
            <div>
              <label className="mb-1 block text-[11px] uppercase tracking-wider text-muted-foreground">
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                className="w-full rounded-md border border-border/50 bg-background px-3 py-2 text-[13px]"
                placeholder="Membangun peta interaktif..."
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="linkedin" className="text-[13px]">
                Aktifkan Tombol LinkedIn?
              </label>
            </div>
            ...
            {form.linkedin && (
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-md border border-border/50 bg-background px-3 py-2 text-[13px]"
                  placeholder="Misal: https://linkedin.com/..."
                />
              </div>
            )}
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-border/50 bg-background px-3 py-2 text-[13px]"
                placeholder="Misal: user@email.com"
              />
            </div>
            <div>
              <label className="mb-1 block text-[11px] uppercase tracking-wider text-muted-foreground">
                ...
                {team.map((t) => (
                  <tr key={t.id}>
                    <td className="px-4 py-3 font-medium flex items-center gap-3">
                      {t.foto_url && (
                        <img src={t.foto_url} alt="" className="size-8 rounded-full object-cover" />
                      )}
                      {t.nama}
                    </td>
